...
<?php
	...
	if($result){
			...
			$mail->Subject = "Successfully Verified on 63-Blogger";
			...
			// $mail->msgHTML("$message");
				...
				$mail->msgHTML(
					"Congrats Your Account is Verified by the Admin on 63-blogger.com<br>".	
					"Login at : www.63blogger/login.com<br>".	
