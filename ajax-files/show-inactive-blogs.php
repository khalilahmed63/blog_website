...
require_once '../required/connection.php';
      ...
      $active_blog_query = "SELECT * FROM blog WHERE blog_status = 'InActive'";
           ...
           if ($active_blog_result->num_rows) {
             ...
             while ($active_blog_row = mysqli_fetch_assoc($active_blog_result)) {
               ...
               <td>
                   ...
                   <button onclick='active_blog(".$active_blog_row['blog_id'].")' type='button' class='btn btn-primary btn-sm'>Active</button>
