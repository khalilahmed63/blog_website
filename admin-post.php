      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
              <!-- profile content start -->
                <div class="text-center bg-warning"><img src="" id="post_image" alt='User Image' class="" width="100%" height="200px"> </div>
               
                  <div class="col-md-12">
                    <p class=" p-2  ">Post Id : <span  id="post_id" class='text-dark '></span> </p>
                  </div>
                  <div class="col-md-12">
                    <p class=" p-2  " id="">Post Title : <span  id="post_title" class='text-dark '></span></p>
                  </div>
                  <div class="col-md-12">
                    <p class=" p-2  " id="">Post Title : <span  id="post_desc" class='text-dark '></span></p>
                  </div>
                  <div class="col-md-12 ">
                    <p class=" p-2  " id="">Post Status : <span  id="post_status" class='text-dark '></span></p>
                  </div>
                   <div class="col-md-12 ">
                    <p class=" p-2  " id="">Created At : <span  id="created_at" class='text-dark created_at'></span></p>
                  </div>
                   <div class="col-md-12 ">
                    <p class=" p-2  " id="">Updated At : <span  id="updated_at" class='text-dark updated_at'></span></p>
                  </div>
	...
	<div class="tabs">
		<ul>
			...
			<li>
				...
				<span class="text">Active Post</span>
			</li>
			<li>
				
				<span class="text">In-Active Post</span>
			</li>
...
<tfoot>
    <tr>
		...
		<div class="tab_wrap" style="display: none;">
			<div class="tab_content" id='show_add_post'>
...
<p id="message" class="text-success fw-bold"></p>
<h2 class="p-3">In-Active Post</h2>
...
<script type="text/javascript">
      ...
      function show_total_posts(){
        ...
        ajax_request.open("POST","ajax-files/show-total-posts.php",true);
        ...
        ajax_request.onreadystatechange = function(){
          if(this.readyState == 4 && this.status == 200){
            ...
            document.getElementById("show_total_posts").innerHTML = this.responseText;
...
<script type="text/javascript">
      ...
      function show_add_post(){
        ...
        ajax_request.open("POST","ajax-files/show-add-post.php",true);
        ajax_request.setRequestHeader("content-type","application/x-www-form-urlencoded");
        ajax_request.send();
        ...
        ajax_request.onreadystatechange = function(){
          if(this.readyState == 4 && this.status == 200){
            ...
            document.getElementById("show_add_post").innerHTML = this.responseText;
...
function view_post(post_id){
    ...
    post_record = document.getElementById('post_record_'+post_id);
    var Cells = post_record.getElementsByTagName("td");

    document.getElementById('post_id').innerText = Cells[1].innerText;
    document.getElementById('post_title').innerText = Cells[2].innerText;
    document.getElementById('post_desc').innerText = Cells[3].innerText;
    document.getElementById('post_image').src = 'images/blog-images/'+Cells[5].innerText;
    document.getElementById('post_status').innerText = Cells[6].innerText;
    document.getElementById('created_at').innerText = Cells[8].innerText;
    document.getElementById('updated_at').innerText = Cells[9].innerText;
